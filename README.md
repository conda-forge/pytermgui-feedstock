...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytermgui-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15051&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytermgui-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytermgui` can be installed with:

```
conda install pytermgui
```

It is possible to list all of the versions of `pytermgui` available on your platform with:
